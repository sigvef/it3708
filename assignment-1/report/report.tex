...
This report presents a homogeneous robotic swarm that can identify interesting objects and push them to desired areas.
...
To resolve these issues we introduced rewards for collaboration when retrieving food, but decided against implementing anti-stuck behaviour as it was not interfering with our goals at this time.
