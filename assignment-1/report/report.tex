...
This behaviour is intended to let agents push food to a goal area.
It is triggered when the agent detects that food is right infront of it.
...
To reward agents who are pushing together in the same direction, $ N $ increases proportionally with the amount of other agents observed directly besides the agent.
