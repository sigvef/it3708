...
file {measurements/1-box-7-epucks-without-unstick-random-placement-bad-reposition-0c4ad0674e83c6681d4769371fe55f976d71ab72.txt};
\draw[red] (axis cs:38.336,0) -- (axis cs:38.336,57) node [right=0.1cm] {38.336 s};
\draw (axis cs:1500,42) node {\usebox{\zoomsinglebad}};
\end{axis}
\end{tikzpicture}
}}%
...
\addplot+[hist={data={x}, bins=20, data max=2000, intervals=false}]%
file {measurements/1-box-7-epucks-without-unstick-random-placements-b35d4c771d6b71e88f73cf833ed8067aad97f4ff.txt};%
\draw[red] (axis cs:21.344,0) -- (axis cs:21.344,67) node [right=0.15cm] {21.344 s};%
\draw (axis cs:1500,49) node {\usebox{\zoomsinglegood}};
\end{axis}%
\end{tikzpicture}%
...
\draw[red] (axis cs:647.872,0) -- (axis cs:647.872,10) node [right] {647.872 s};
\end{axis}
\end{tikzpicture}
}}%
